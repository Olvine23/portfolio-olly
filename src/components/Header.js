...
export const Header = () => {
    return (
      <div className="px-4 py-16 mx-auto sm:max-w-xl  md:max-w-full lg:w-500 md:px-24 lg:px-8 lg:py-20">
        <div className="flex flex-col items-center bg-green-900 justify-between lg:flex-row">
          <div className="mb-10 lg:max-w-lg lg:pr-5 lg:mb-0">
            <div className="max-w-xl mb-6 p-7">
              <div>
